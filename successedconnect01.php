...
$sql_update="UPDATE customer SET Username='$_GET[Username]',password='$_GET[password]',gender='$_GET[gender]',education='$_GET[education]',email='$_GET[email]',hobby='$_GET[hobby]'
